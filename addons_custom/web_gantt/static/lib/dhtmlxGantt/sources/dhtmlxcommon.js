...
"undefined" == typeof window.dhx4 && (window.dhx4 = {
    ...
    readFromCss: function(t, e) {
        ...
        n.className = t,
        null != document.body.firstChild ? document.body.insertBefore(n, document.body.firstChild) : document.body.appendChild(n);
    ...
    zim: {
        ...
        last: function() {
            ...
            for (var e in this.data)
                t = Math.max(t, this.data[e]);
            return t
        },
        reserve: function(t) {
            return this.data[t] = this.last() + this.step,
            this.data[t]
        },
        clear: function(t) {
            null != this.data[t] && (this.data[t] = null,
            delete this.data[t])
        }
    },
    s2b: function(t) {
        return "string" == typeof t && (t = t.toLowerCase()),
        1 == t || 1 == t || "true" == t || "1" == t || "yes" == t || "y" == t
    },
    s2j: function(s) {
        var obj = null;
        dhx4.temp = null;
        ...
        return obj = dhx4.temp,
        dhx4.temp = null,
        obj
    },
    absLeft: function(t) {
        return "string" == typeof t && (t = document.getElementById(t)),
        this.getOffset(t).left
    },
    absTop: function(t) {
        return "string" == typeof t && (t = document.getElementById(t)),
        this.getOffset(t).top
    },
    _aOfs: function(t) {
        for (var e = 0, n = 0; t; )
            e += parseInt(t.offsetTop),
            n += parseInt(t.offsetLeft),
            t = t.offsetParent;
        return {
            top: e,
            left: n
    ...
    _copyObj: function(t) {
        if (this._isObj(t)) {
            var e = {};
            for (var n in t)
                "object" == typeof t[n] && null != t[n] ? e[n] = this._copyObj(t[n]) : e[n] = t[n]
        } else
    ...
    screenDim: function() {
        var t = navigator.userAgent.indexOf("MSIE") >= 0
          , e = {};
        return e.left = document.body.scrollLeft,
        e.right = e.left + (window.innerWidth || document.body.clientWidth),
        e.top = Math.max((t ? document.documentElement : document.getElementsByTagName("html")[0]).scrollTop, document.body.scrollTop),
        e.bottom = e.top + (t ? Math.max(document.documentElement.clientHeight || 0, document.documentElement.offsetHeight || 0) : window.innerHeight),
        e
    },
    selectTextRange: function(t, e, n) {
        t = "string" == typeof t ? document.getElementById(t) : t;
        var i = t.value.length;
        if (e = Math.max(Math.min(e, i), 0),
        n = Math.min(n, i),
        t.setSelectionRange)
            try {
    ...
    transDetect: function() {
        if (null == this.transData) {
            ...
            for (var e in t)
                0 == this.transData.transProp && null != document.documentElement.style[e] && (this.transData.transProp = e,
    ...
    _xmlNodeValue: function(t) {
        for (var e = "", n = 0; n < t.childNodes.length; n++)
            e += null != t.childNodes[n].nodeValue ? t.childNodes[n].nodeValue.toString().replace(/^[\n\r\s]{0,}/, "").replace(/[\n\r\s]{0,}$/, "") : "";
        return e
    }
},
window.dhx4.isIE = navigator.userAgent.indexOf("MSIE") >= 0 || navigator.userAgent.indexOf("Trident") >= 0,
window.dhx4.isIE6 = null == window.XMLHttpRequest && navigator.userAgent.indexOf("MSIE") >= 0,
...
"undefined" == typeof window.dhx4.ajax && (window.dhx4.ajax = {
    cache: !1,
    method: "get",
    parse: function(t) {
        if ("string" != typeof t)
    ...
    xmltop: function(t, e, n) {
        if ("undefined" == typeof e.status || e.status < 400) {
            ...
            if (i && null !== i.documentElement && !i.getElementsByTagName("parsererror").length)
                return i.getElementsByTagName(t)[0]
        }
        return -1 !== n && dhx4.callEvent("onLoadXMLError", ["Incorrect XML", arguments[1], n]),
    ...
    xpath: function(t, e) {
        ...
        for (var n, i = [], a = (e.ownerDocument || e).evaluate(t, e, null, XPathResult.ANY_TYPE, null); n = a.iterateNext(); )
            i.push(n);
        return i
    },
    query: function(t) {
    ...
    post: function(t, e, n) {
        1 == arguments.length ? e = "" : 2 != arguments.length || "function" != typeof e && "function" != typeof window[e] ? e = String(e) : (n = e,
        e = ""),
    ...
    _call: function(t, e, n, i, a, s, r) {
        ...
        if (1 == i && (o.onreadystatechange = function() {
            if (4 == o.readyState || 1 == d && 3 == o.readyState) {
                if ((200 != o.status || "" == o.responseText) && !dhx4.callEvent("onAjaxError", [o]))
                    return;
                window.setTimeout(function() {
                    "function" == typeof a && a.apply(window, [{
                        xmlDoc: o
                    }]),
                    null != s && ("undefined" != typeof s.postData ? dhx4.ajax.postLong(s.url, s.postData, a) : dhx4.ajax.getLong(s.url, a)),
                    a = null,
                    o = null
                }, 1)
            }
        ...
        "GET" == t && 1 != this.cache && (e += (e.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (new Date).getTime() + "=1"),
        o.open(t, e, i),
        r)
            for (var _ in r)
                o.setRequestHeader(_, r[_]);
        else
            "POST" == t.toUpperCase() || "PUT" == t || "DELETE" == t ? o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded") : "GET" == t && (n = null);
...
"undefined" == typeof window.dhx4._eventable && (window.dhx4._eventable = function(t, e) {
    return "clear" == e ? (t.detachAllEvents(),
    t.dhxevs = null,
    t.attachEvent = null,
    t.detachEvent = null,
    t.checkEvent = null,
    t.callEvent = null,
    t.detachAllEvents = null,
    void (t = null)) : (t.dhxevs = {
        data: {}
    },
    t.attachEvent = function(t, e) {
        t = String(t).toLowerCase(),
        this.dhxevs.data[t] || (this.dhxevs.data[t] = {});
        var n = window.dhx4.newId();
        return this.dhxevs.data[t][n] = e,
        n
    }
    ,
    t.detachEvent = function(t) {
        for (var e in this.dhxevs.data) {
            var n = 0;
            for (var i in this.dhxevs.data[e])
                i == t ? (this.dhxevs.data[e][i] = null,
                delete this.dhxevs.data[e][i]) : n++;
            0 == n && (this.dhxevs.data[e] = null,
    ...
    t.callEvent = function(t, e) {
        ...
        null == this.dhxevs.data[t])
            return !0;
        var n = !0;
        for (var i in this.dhxevs.data[t])
            n = this.dhxevs.data[t][i].apply(this, e) && n;
        return n
    }
    ,
    t.detachAllEvents = function() {
        for (var t in this.dhxevs.data) {
            for (var e in this.dhxevs.data[t])
                this.dhxevs.data[t][e] = null,
                delete this.dhxevs.data[t][e];
            this.dhxevs.data[t] = null,
            delete this.dhxevs.data[t]
        }
    }
    ,
    void (t = null))
...
"undefined" == typeof window.dhtmlx && (window.dhtmlx = {
    extend: function(t, e) {
        for (var n in e)
            t[n] || (t[n] = e[n]);
        return t
    ...
    extend_api: function(t, e, n) {
        ...
        ,
        window[t].prototype = i.prototype,
        n && dhtmlx.extend(window[t].prototype, n))
    },
    url: function(t) {
        return -1 != t.indexOf("?") ? "&" : "?"
    }
...
(-1 != navigator.appVersion.indexOf("MSIE 8.0") || -1 != navigator.appVersion.indexOf("MSIE 9.0") || -1 != navigator.appVersion.indexOf("MSIE 10.0") || document.documentMode > 7) && "BackCompat" != document.compatMode && (_isIE = 8)) : "Netscape" == navigator.appName && -1 != navigator.userAgent.indexOf("Trident") ? _isIE = 8 : (_isFF = !0,
_FFrv = parseFloat(navigator.userAgent.split("rv:")[1])),
"undefined" == typeof window.dhtmlxEvent,
null == dhtmlxEvent.touchDelay && (dhtmlxEvent.touchDelay = 2e3),
"undefined" == typeof dhtmlxEvent.initTouch && (dhtmlxEvent.initTouch = function() {
    function t() {
        if (n) {
            var t = document.createEvent("HTMLEvents");
            t.initEvent("dblclick", !0, !0),
            n.dispatchEvent(t),
            e = n = null
        }
    }
    ...
    dhtmlxEvent(document.body, "touchstart", function(s) {
        n = s.touches[0].target,
        i = s.touches[0].clientX,
        a = s.touches[0].clientY,
        e = window.setTimeout(t, dhtmlxEvent.touchDelay);
    }),
    dhtmlxEvent(document.body, "touchmove", function(t) {
        e && (Math.abs(t.touches[0].clientX - i) > 50 || Math.abs(t.touches[0].clientY - a) > 50) && (window.clearTimeout(e),
        e = n = !1)
    }),
...
function() {
    ...
    function e(e) {
        if (g) {
            ...
            return dhtmlx.message.keyboard && ((13 == n || 32 == n) && t(g, !0),
            27 == n && t(g, !1)),
    ...
    function a(t) {
        c.area || (c.area = document.createElement("DIV"),
        c.area.className = "dhtmlx_message_area",
        c.area.style[c.position] = "5px",
        document.body.appendChild(c.area)),
        c.hide(t.id);
        ...
        ,
        "bottom" == c.position && c.area.firstChild ? c.area.insertBefore(e, c.area.firstChild) : c.area.appendChild(e),
        t.expire > 0 && (c.timers[t.id] = window.setTimeout(function() {
            c.hide(t.id)
        }, t.expire)),
        c.pull[t.id] = e,
        e = null,
    ...
    function s(e, n, a) {
        ...
        s.className = " dhtmlx_modal_box dhtmlx-" + e.type,
        s.setAttribute("dhxbox", 1);
        var r = "";
        if (e.width && (s.style.width = e.width),
        e.height && (s.style.height = e.height),
        e.title && (r += '<div class="dhtmlx_popup_title">' + e.title + "</div>"),
        r += '<div class="dhtmlx_popup_text"><span>' + (e.content ? "" : e.text) + '</span></div><div  class="dhtmlx_popup_controls">',
        n && (r += i(e.ok || "OK", !0)),
        a && (r += i(e.cancel || "Cancel", !1)),
        e.buttons)
        ...
        e.content) {
            ...
            s.childNodes[e.title ? 1 : 0].appendChild(d)
        }
        return s.onclick = function(n) {
            n = n || event;
            var i = n.target || n.srcElement;
            if (i.className || (i = i.parentNode),
            "dhtmlx_popup_button" == i.className.split(" ")[0]) {
    ...
    function r(t, i, a) {
        ...
        return "top" == t.position ? r.style.top = "-3px" : r.style.top = d + "px",
        r.style.left = o + "px",
        r.onkeydown = e,
        r.focus(),
        t.hidden && dhtmlx.modalbox.hide(r),
        r
    }
    function o(t) {
        return r(t, !0, !1)
    ...
    ;
    var c = dhtmlx.message = function(t, e, n, i) {
    ...
    c.hide = function(t) {
        ...
        e.className += " hidden",
        c.timers[t] && window.clearTimeout(c.timers[t]),
        delete c.pull[t])
    }
}(),
dataProcessor.prototype = {
    setTransactionMode: function(t, e) {
        ...
        this._payload = this._payload || t.payload) : (this._tMode = t,
        this._tSend = e),
    ...
    markRow: function(t, e, n) {
        ...
        e = !0),
        this.callEvent("onRowMark", [t, e, n, a]) && (i = this.styles[e ? n : "clear"] + i,
        this.obj[this._methods[0]](t, i),
        a && a.details)) {
            i += this.styles[a + "_cell"];
            for (var s = 0; s < a.details.length; s++)
                a.details[s] && this.obj[this._methods[1]](t, s, i)
        }
    },
    getState: function(t) {
    ...
    serialize: function(t, e) {
        ...
        var n = []
          , i = [];
        for (var a in t)
            t.hasOwnProperty(a) && (n.push(this.serialize_one(t[a], a + this.post_delim)),
            i.push(a));
        return n.push("ids=" + this.escape(i.join(","))),
        dhtmlx.security_key && n.push("dhx_security=" + dhtmlx.security_key),
        n.join("&")
    },
    ...
    _sendData: function(t, e) {
        if (t) {
            ...
            if ("GET" == this._tMode)
                dhx4.ajax.get(a + (-1 != a.indexOf("?") ? "&" : "?") + this.serialize(t, e), i);
            else if ("POST" == this._tMode)
                dhx4.ajax.post(a, this.serialize(t, e), i);
            else if ("REST" == this._tMode) {
                var s = this.getState(e)
                  , r = a.replace(/(\&|\?)editing\=true/, "")
                  , o = ""
                  , d = "post";
                if ("inserted" == s ? o = this.serialize(t, e) : "deleted" == s ? (d = "DELETE",
                r = r + ("/" == r.slice(-1) ? "" : "/") + e) : (d = "PUT",
                o = this.serialize(t, e),
                r = r + ("/" == r.slice(-1) ? "" : "/") + e),
                this._payload)
                    for (var _ in this._payload)
                        r = r + dhtmlx.url(r) + this.escape(_) + "=" + this.escape(this._payload[_]);
                dhx4.ajax.query({
                    url: r,
                    method: d,
    ...
    afterUpdateCallback: function(t, e, n, i) {
        ...
        case "inserted":
        case "insert":
            e != t && (this.obj[this._methods[2]](t, e),
            t = e);
            break;
        case "delete":
        case "deleted":
        ...
        this.callEvent("onAfterUpdate", [r, n, e, i]);
    },
        ...
        if (window.JSON)
            try {
                var i = JSON.parse(e.xmlDoc.responseText)
                  ...
                  , s = i.sid || n[0]
                  , r = i.tid || n[0];
                return t.afterUpdateCallback(s, r, a, i),
                void t.finalizeUpdate()
            } catch (o) {}
        var d = dhx4.ajax.xmltop("data", e.xmlDoc);
        if (!d)
            return this.cleanUpdate(n);
    ...
    setAutoUpdate: function(t, e) {
        ...
        this._loader = null,
        this._update_busy = !1,
        this.attachEvent("onAfterUpdate", function(t, e, n, i) {
    ...
    fullSync: function() {
        return 1 == this._need_update && (this._need_update = !1,
        this.loadUpdate()),
        !0
    },
    getUpdates: function(t, e) {
        return this._update_busy ? !1 : (this._update_busy = !0,
        this._loader = this._loader || new dtmlXMLLoaderObject(!0),
        this._loader.async = !0,
        this._loader.waitCall = e,
        void this._loader.loadXML(t))
    },
    _v: function(t) {
...
Gantt.getGanttInstance = function() {
    ...
    function dhtmlxDnD(t, e) {
        ...
        dhtmlxEvent(t, "mousedown", dhtmlx.bind(function(n) {
            e.original_target = {
    ...
    dhtmlxEventable = function(obj) {
        ...
        obj.attachEvent = function(t, e, n) {
            ...
            this[t] || (this[t] = new this._eventCatcher(n || this)),
            t + ":" + this[t].addEvent(e)
        }
        ,
        obj.callEvent = function(t, e) {
            return this._silent_mode ? !0 : (t = "ev_" + t.toLowerCase(),
            this[t] ? this[t].apply(this, e) : !0)
        }
        ,
    ...
    dhtmlx.copy = function(t) {
        ...
        if (t && "object" == typeof t) {
            ...
            e = 0; e < n.length; e++)
                t instanceof n[e] && (i = e ? new n[e](t) : new n[e]);
            for (e in t)
                Object.prototype.hasOwnProperty.apply(t, [e]) && (i[e] = dhtmlx.copy(t[e]))
        }
        return i || t
    }
    ,
    ...
    ,
    window.dhtmlx && (dhtmlx.attaches || (dhtmlx.attaches = {}),
    dhtmlx.attaches.attachGantt = function(t, e, n) {
        var i = document.createElement("DIV");
        i.id = "gantt_" + dhtmlx.uid(),
        i.style.width = "100%",
        i.style.height = "100%",
        i.cmp = "grid",
        n = n || window.gantt,
    ...
    gantt._on_click = function(t) {
        ...
        var e = t.target || t.srcElement
          , n = gantt.locate(t)
          , i = !0;
        if (null !== n ? i = !gantt.checkEvent("onTaskClick") || gantt.callEvent("onTaskClick", [n, t]) : gantt.callEvent("onEmptyClick", [t]),
        i) {
    ...
    gantt._on_mousemove = function(t) {
        if (gantt.checkEvent("onMouseMove")) {
            ...
            gantt._last_move_event = t,
            gantt.callEvent("onMouseMove", [e, t])
        }
    }
    ,
    dhtmlxDnD.prototype = {
        dragStart: function(t, e) {
            ...
            dhtmlx.bind(function(t) {
              ...
              , a = dhtmlx.bind(function(e) {
                return dhtmlxDetachEvent(document.body, "mousemove", i),
                dhtmlxDetachEvent(document.body, "mouseup", a),
                this.dragEnd(t)
            }, this);
            dhtmlxEvent(document.body, "mousemove", i),
            dhtmlxEvent(document.body, "mouseup", a),
        ...
        dragMove: function(t, e) {
            if (!this.config.marker && !this.config.started) {
                ...
                if (s > this.config.sensitivity) {
                    ...
                    this.callEvent("onBeforeDragStart", [t, this.config.original_target]) === !1)
                        return this.config.ignore = !0,
                        !0;
                    var r = this.config.marker = document.createElement("div");
                    r.className = "gantt_drag_marker",
                    r.innerHTML = "Dragging object",
                    document.body.appendChild(r),
                    this.callEvent("onAfterDragStart", [t, this.config.original_target])
                } else
                    this.config.ignore = !0
            }
            this.config.ignore || (e.pos = this.getPosition(e),
        ...
        getPosition: function(t) {
            ...
            n = t.pageY) : (t.clientX || t.clientY) && (e = t.clientX + document.body.scrollLeft + document.documentElement.scrollLeft,
    ...
    gantt._init_grid = function() {
        ...
        this._click.gantt_open = dhtmlx.bind(function(t, e, n) {
            return this.open(e),
            !1
        }, this),
        this._click.gantt_row = dhtmlx.bind(function(t, e, n) {
            if (null !== e) {
                var i = this.getTask(e);
                this.config.scroll_on_click && this.showDate(i.start_date),
                this.callEvent("onTaskRowClick", [e, n])
            }
        }, this),
        this._click.gantt_grid_head_cell = dhtmlx.bind(function(t, e, n) {
            var i = n.getAttribute("column_id");
            if (this.callEvent("onGridHeaderClick", [i, t])) {
                if ("add" == i)
                    return void this._click.gantt_add(t, this.config.root_id);
                if (this.config.sort) {
                    for (var a, s = i, r = 0; this.config.columns.length; r++)
                        if (this.config.columns[r].name == i) {
                            a = this.config.columns[r];
                            break
                        }
                    if (a && void 0 !== a.sort && a.sort !== !0 && (s = a.sort,
                    !s))
                        return;
                    var o = this._sort && this._sort.direction && this._sort.name == i ? this._sort.direction : "desc";
                    o = "desc" == o ? "asc" : "desc",
                    this._sort = {
                        name: i,
                        direction: o
        ...
        this._click.gantt_add = dhtmlx.bind(function(t, e, n) {
            if (!this.config.readonly) {
                var i = {};
                return this.createTask(i, e ? e : this.config.root_id),
                !1
            }
        }, this),
    ...
    gantt._render_grid_header = function() {
        for (var t = this.getGridColumns(), e = [], n = 0, i = this.locale.labels, a = this.config.scale_height - 2, s = 0; s < t.length; s++) {
            var r = s == t.length - 1
              , o = t[s];
            r && this._get_grid_width() > n + o.width && (o.width = this._get_grid_width() - n),
            n += o.width;
            ...
            h = h || "";
            var g = "<div class='" + _ + "' style='" + l + "' column_id='" + o.name + "'>" + h + d + "</div>";
            e.push(g)
        }
    ...
    gantt._render_grid_item = function(t) {
        ...
        for (var e = this.getGridColumns(), n = [], i = 0; i < e.length; i++) {
            ...
            s instanceof Date && (s = this.templates.date_grid(s, t)),
            s = "<div class='gantt_tree_content'>" + s + "</div>");
            var d = "gantt_cell" + (r ? " gantt_last_cell" : "")
              , _ = "";
            if (o.tree) {
                for (var l = 0; l < t.$level; l++)
                    _ += this.templates.grid_indent(t);
                var h = this._has_children(t.id);
                h ? (_ += this.templates.grid_open(t),
                _ += this.templates.grid_folder(t)) : (_ += this.templates.grid_blank(t),
                _ += this.templates.grid_file(t))
            }
            var g = "width:" + (o.width - (r ? 1 : 0)) + "px;";
            dhtmlx.defined(o.align) && (g += "text-align:" + o.align + ";"),
            a = "<div class='" + d + "' style='" + g + "'>" + _ + s + "</div>",
            n.push(a)
        }
        var d = t.$index % 2 === 0 ? "" : " odd";
        if (d += t.$transparent ? " gantt_transparent" : "",
        d += t.$dataprocessor_class ? " " + t.$dataprocessor_class : "",
        ...
        return u.className = "gantt_row" + d,
        u.style.height = this.config.row_height + "px",
        u.style.lineHeight = gantt.config.row_height + "px",
        u.setAttribute(this.config.task_attribute, t.id),
        u.innerHTML = n.join(""),
        u
    }
    ,
    gantt.open = function(t) {
        gantt._set_item_state(t, !0),
        this.callEvent("onTaskOpened", [t])
    }
    ,
    gantt.close = function(t) {
        gantt._set_item_state(t, !1),
        this.callEvent("onTaskClosed", [t])
    }
    ,
    gantt._set_item_state = function(t, e) {
        t && this._pull[t] && (this._pull[t].$open = e,
        gantt._refresh_on_toggle_element(t))
    }
    ,
    ...
    gantt.moveTask = function(t, e, n) {
        ...
        if (t != n) {
            ...
            if (this.callEvent("onBeforeTaskMove", [t, n, e]) !== !1) {
                ...
                var d = r[e];
                d ? r = r.slice(0, e).concat([t]).concat(r.slice(e)) : r.push(t),
                this.setParent(a, n),
                this._branches[n] = r,
                a.$level = this.calculateTaskLevel(a),
                1 * e > 0 ? i ? a.$drop_target = (this.getTaskIndex(t) > this.getTaskIndex(i) ? "next:" : "") + i : a.$drop_target = "next:" + gantt.getPrevSibling(t) : r[1 * e + 1] ? a.$drop_target = r[1 * e + 1] : a.$drop_target = n,
                this.callEvent("onAfterTaskMove", [t, n, e]) && this.refreshData()
            }
        }
    }
    ,
    gantt._init_dnd = function() {
        ...
        dhtmlx.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity),
        t.attachEvent("onBeforeDragStart", dhtmlx.bind(function(e, n) {
            ...
            var a = this.locate(n)
              , s = gantt.getTask(a);
            return gantt._is_readonly(s) ? !1 : (t.config.initial_open_state = s.$open,
            this.callEvent("onRowDragStart", [a, n.target || n.srcElement, n]) ? void 0 : !1)
        }, this)),
        t.attachEvent("onAfterDragStart", dhtmlx.bind(function(e, n) {
            var i = this._locateHTML(n);
            t.config.marker.innerHTML = i.outerHTML,
            t.config.id = this.locate(n);
            var a = this.getTask(t.config.id);
            t.config.index = this.getTaskIndex(t.config.id),
            t.config.parent = a.parent,
            a.$open = !1,
            a.$transparent = !0,
            this.refreshData()
        }, this)),
        t.lastTaskOfLevel = function(t) {
            for (var e = gantt._order, n = gantt._pull, i = null, a = 0, s = e.length; s > a; a++)
                n[e[a]].$level == t && (i = n[e[a]]);
            return i ? i.id : null
        }
        ,
        t._getGridPos = dhtmlx.bind(function(t) {
            var e = this._get_position(this.$grid_data)
              ...
              , i = t.pos.y - 10;
            return i < e.y && (i = e.y),
            i > e.y + this.$grid_data.offsetHeight - this.config.row_height && (i = e.y + this.$grid_data.offsetHeight - this.config.row_height),
            e.x = n,
            e.y = i,
            e
        }, this),
        t.attachEvent("onDragMove", dhtmlx.bind(function(e, n) {
            ...
            if (this.isTaskExists(d) || (d = t.lastTaskOfLevel(gantt.config.order_branch_free ? _.$level : 0),
            d == t.config.id && (d = null)),
            this.isTaskExists(d)) {
                var l = gantt._get_position(o)
                  , h = this.getTask(d);
                if (l.y + o.offsetHeight / 2 < r) {
                    var g = this.getGlobalTaskIndex(h.id)
                      , c = this._pull[this._order[g + 1]];
                    if (c) {
                        if (c.id == _.id)
                            return;
                        h = c
                    } else if (c = this._pull[this._order[g]],
                    i(c, _) && c.id != _.id)
                        return void this.moveTask(_.id, -1, this.getParent(c.id))
                }
                for (var g = this.getGlobalTaskIndex(h.id), u = this._pull[this._order[g - 1]], f = 1; (!u || u.id == h.id) && g - f >= 0; )
                    u = this._pull[this._order[g - f]],
                    f++;
                if (_.id == h.id)
                    return;
                i(h, _) && _.id != h.id ? this.moveTask(_.id, 0, 0, h.id) : h.$level != _.$level - 1 || gantt.getChildren(h.id).length ? u && i(u, _) && _.id != u.id && this.moveTask(_.id, -1, this.getParent(u.id)) : this.moveTask(_.id, 0, h.id);
            }
            return !0
        }, this)),
        t.attachEvent("onDragEnd", dhtmlx.bind(function() {
            var e = this.getTask(t.config.id);
            this.callEvent("onBeforeRowDragEnd", [t.config.id, t.config.parent, t.config.index]) === !1 ? (this.moveTask(t.config.id, t.config.index, t.config.parent),
            e.$drop_target = null) : this.callEvent("onRowDragEnd", [t.config.id, e.$drop_target]),
            e.$transparent = !1,
            e.$open = t.config.initial_open_state,
            this.refreshData()
        }, this))
    }
    ,
    ...
    gantt._render_grid_header_resize = function() {
        for (var t = this.getGridColumns(), e = 0, n = this.config.scale_height, i = (this._get_position(this.$grid_scale),
        0); i < t.length; i++) {
            var a = (i == t.length - 1,
            t[i]);
            if (e += a.width,
            a.resize) {
                ...
                s.setAttribute(this.config.grid_resizer_column_attribute, i),
                this.$grid_scale.appendChild(s),
                s.style.left = Math.max(0, e - 1 - s.offsetWidth / 2) + "px";
            }
        }
        if (this.config.grid_resize) {
            var r = document.createElement("div");
            r.className = "gantt_grid_resize_wrap",
            r.style.top = "0px",
            r.style.height = this.$grid.offsetHeight + "px",
            r.innerHTML = "<div class='gantt_grid_resize'></div>",
            r.setAttribute(this.config.grid_resizer_attribute, !0),
            this.$grid_scale.appendChild(r),
            r.style.left = Math.max(0, this.config.grid_width - 1 - r.offsetWidth / 2) + "px"
        }
    }
    ,
    gantt._init_resize = function() {
        ...
        dhtmlx.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity),
        t.attachEvent("onBeforeDragStart", dhtmlx.bind(function(t, e) {
        ...
        t.attachEvent("onAfterDragStart", dhtmlx.bind(function(e, n) {
            ...
            t.config.drag_index = i
        }, this)),
        t.attachEvent("onDragMove", dhtmlx.bind(function(e, n) {
            var i = t.config
              , a = this.getGridColumns()
              , s = this._get_position(this.$grid_scale)
              , r = parseInt(i.marker.style.left, 10)
              , o = this.config.min_grid_column_width
              , d = this.$grid_data.offsetWidth - this.config.min_grid_column_width * (a.length - i.drag_index - 2)
              , _ = 0
              , l = 0;
            r -= s.x - 1;
            for (var h = 0; h < i.drag_index; h++)
                o += a[h].width,
                _ += a[h].width;
            return o > r && (r = o),
            this.config.keep_grid_width && r > d && (r = d),
            l = r - _,
            i.marker.style.top = s.y + "px",
            i.marker.style.left = s.x - 1 + _ + "px",
            i.marker.style.width = l + "px",
            i.left = r - 1,
            gantt.callEvent("onColumnResize", [i.drag_index, a[i.drag_index], l - 1]),
            !0
        }, this)),
        t.attachEvent("onDragEnd", dhtmlx.bind(function(e, n) {
            for (var i = this.getGridColumns(), a = 0, s = parseInt(t.config.drag_index, 10), r = i[s], o = 0; s > o; o++)
                a += i[o].width;
            var d = r.min_width && t.config.left - a < r.min_width ? r.min_width : t.config.left - a;
            if (gantt.callEvent("onColumnResizeEnd", [s, r, d]) !== !1 && r.width != d) {
                if (r.width = d,
                this.config.keep_grid_width)
                    for (var o = s + 1, _ = i.length; _ > o; o++)
                        "add" == i[o].name ? i[o].width = 1 * i[o].width || 44 : i[o].width = null;
                else {
                    for (var o = s, _ = i.length; _ > o; o++)
                        a += i[o].width;
                    this.config.grid_width = a
                }
                this.render()
            }
        }, this));
        ...
        dhtmlx.defined(this.config.dnd_sensitivity) && (e.config.sensitivity = this.config.dnd_sensitivity),
        e.attachEvent("onBeforeDragStart", dhtmlx.bind(function(t, e) {
        ...
        e.attachEvent("onAfterDragStart", dhtmlx.bind(function(t, n) {
            e.config.marker.innerHTML = "",
            e.config.marker.className += " gantt_grid_resize_area",
            e.config.marker.style.height = this.$grid.offsetHeight + "px",
            e.config.marker.style.top = "0px"
        }, this)),
        e.attachEvent("onDragMove", dhtmlx.bind(function(t, n) {
            for (var i = e.config, a = this.config.columns, s = this._get_position(this.$grid), r = parseInt(i.marker.style.left, 10), o = 0, d = 0; d < a.length; d++)
                a[d].hide || (o += a[d].min_width ? a[d].min_width : this.config.min_grid_column_width);
            return r -= s.x - 1,
            o > r && (r = o),
            i.marker.style.top = s.y + "px",
            i.marker.style.left = s.x - 1 + "px",
            i.marker.style.width = r + "px",
            i.left = r - 1,
            gantt.callEvent("onGridResize", [this.config.grid_width, r - 1]),
            !0
        }, this)),
        e.attachEvent("onDragEnd", dhtmlx.bind(function(t, n) {
            for (var i = this.config.columns, a = 0, s = e.config.left, r = 0, o = i.length; o > r; r++)
                i[r].hide || (a += i[r].width);
            for (var d = i.length, _ = s - a, r = 0; d > r; r++)
                if (!i[r].hide) {
                    var l = Math.floor(_ * (i[r].width / a));
                    a -= i[r].width;
                    var h = i[r].width + l;
                    (i[r].min_width && h >= i[r].min_width || !i[r].min_width || h > i[r].width) && (_ -= l,
                    i[r].width = h)
                }
            for (var g = _ > 0 ? 1 : -1; _ > 0 && 1 === g || 0 > _ && -1 === g; ) {
                var c = _;
                for (r = 0; d > r; r++) {
                    var u = i[r].width + g;
                    if ((i[r].min_width && u >= i[r].min_width || !i[r].min_width || h > i[r].width) && (_ -= g,
                    i[r].width = u,
                    0 == _))
                        break
                }
            ...
            gantt.callEvent("onGridResizeEnd", [this.config.grid_width, s]) !== !1 && (this.config.grid_width = s,
            this.render())
        }, this))
    }
    ,
    ...
    gantt.attachEvent("onTaskOpened", function(t) {
        if (gantt.config.branch_loading && gantt._load_url && gantt._need_dynamic_loading(t)) {
            ...
            var n = e.indexOf("?") >= 0 ? "&" : "?"
              , i = 0;
            this._cached_scroll_pos && this._cached_scroll_pos.y && (i = Math.max(this._cached_scroll_pos.y, 0)),
            gantt.load(e + n + "parent_id=" + encodeURIComponent(t), this._load_type, function() {
                i && gantt.scrollTo(null, i)
            }),
    ...
    gantt._scale_helpers = {
        getSum: function(t, e, n) {
            ...
            void 0 === e && (e = 0);
            for (var i = 0, a = e; n >= a; a++)
                i += t[a];
            return i
        },
        setSumWidth: function(t, e, n, i) {
            var a = e.width;
            void 0 === i && (i = a.length - 1),
            void 0 === n && (n = 0);
            var s = i - n + 1;
            if (!(n > a.length - 1 || 0 >= s || i > a.length - 1)) {
                var r = this.getSum(a, n, i)
                  , o = t - r;
                this.adjustSize(o, a, n, i),
                this.adjustSize(-o, a, i + 1),
        ...
        prepareConfigs: function(t, e, n, i) {
            for (var a = this.splitSize(i, t.length), s = n, r = [], o = t.length - 1; o >= 0; o--) {
                ...
                d && this.processIgnores(_),
                this.initColSizes(_, e, s, a[o]),
                this.limitVisibleRange(_),
                d && (s = _.full_width),
                r.unshift(_)
            }
        ...
        initColSizes: function(t, e, n, i) {
            ...
            e && t.col_width < e && (t.col_width = e,
            a = t.col_width * s),
            t.width = [];
            for (var r = t.ignore_x || {}, o = 0; o < t.trace_x.length; o++)
                r[t.trace_x[o].valueOf()] || t.display_count == t.count ? t.width[o] = 0 : t.width[o] = 1;
        ...
        iterateScales: function(t, e, n, i, a) {
            for (var s = e.trace_x, r = t.trace_x, o = n || 0, d = i || r.length - 1, _ = 0, l = 1; l < s.length; l++)
                for (var h = o; d >= h; h++)
                    +r[h] != +s[l] || (a && a.apply(this, [_, l, o, h]),
                    o = h,
                    _ = l)
        },
        ...
        eachColumn: function(t, e, n) {
            ...
            for (+s >= +a && (a = gantt.date.add(s, e, t)); +a > +s; ) {
                ...
                s = gantt.date.add(s, e, t),
                s = gantt._correct_dst_change(s, r, e, t),
        ...
        limitVisibleRange: function(t) {
            ...
            if (a) {
                for (var _ = this.getSum(t.width), l = 0, h = 0; h < t.width.length; h++) {
                    var g = Math.floor(a * (t.width[h] / _));
                    t.width[h] += g,
                    l += g
                }
    ...
    gantt._scale_helpers.processIgnores = function(t) {
        var e = t.count;
        if (t.ignore_x = {},
        gantt.ignore_time || gantt.config.skip_off_time) {
            ...
            for (var i = 0; i < t.trace_x.length; i++)
                n.call(gantt, t.trace_x[i]) || this._ignore_time_config.call(gantt, t.trace_x[i]) ? (t.ignore_x[t.trace_x[i].valueOf()] = !0,
                t.ignored_colls = !0) : e++
        }
        t.display_count = e
    }
    ...
    gantt._tasks_dnd = {
        ...
        set_actions: function() {
            ...
            dhtmlxEvent(t, "mousedown", dhtmlx.bind(function(t) {
                this.on_mouse_down(t || event)
            }, this)),
            dhtmlxEvent(t, "mouseup", dhtmlx.bind(function(t) {
        ...
        _resize: function(t, e, n) {
            ...
            n.left ? (t.start_date = gantt.dateFromPos(a.start + e),
            t.start_date || (t.start_date = new Date(gantt.getState().min_date))) : (t.end_date = gantt.dateFromPos(a.end + e),
            t.end_date || (t.end_date = new Date(gantt.getState().max_date))),
            t.end_date - t.start_date < i.min_duration && (n.left ? t.start_date = gantt.calculateEndDate(t.end_date, -1) : t.end_date = gantt.calculateEndDate(t.start_date, 1)),
        ...
        _move: function(t, e, n) {
            ...
            a ? s ? (t.start_date = a,
            t.end_date = s) : (t.end_date = new Date(gantt.getState().max_date),
            t.start_date = gantt.dateFromPos(gantt.posFromDate(t.end_date) - (i.end - i.start))) : (t.start_date = new Date(gantt.getState().min_date),
            t.end_date = gantt.dateFromPos(gantt.posFromDate(t.start_date) + (i.end - i.start)))
        },
        ...
        on_mouse_move: function(t) {
            ...
            var e = this.drag;
            if (e.mode) {
                if (!gantt._checkTimeout(this, 40))
                    return;
        ...
        _update_on_move: function(t) {
            ...
            if (e.mode) {
                ...
                if (this._handlers[e.mode]) {
                    ...
                    dhtmlx.mixin(s, o, !0),
                    gantt._update_parents(e.id, !0),
                    gantt.callEvent("onTaskDrag", [s.id, e.mode, o, r, t]),
                    dhtmlx.mixin(s, o, !0),
                    gantt._update_parents(e.id),
        ...
        on_mouse_down: function(t, e) {
            if (2 != t.button) {
                var n = gantt.locate(t)
                  , i = null;
                if (gantt.isTaskExists(n) && (i = gantt.getTask(n)),
                !gantt._is_readonly(i) && !this.drag.mode) {
                    this.clear_drag_state(),
                    e = e || t.target || t.srcElement;
                    var a = gantt._getClassName(e);
                    if (!a || !this._get_drag_mode(a))
                    ...
                    if (s)
                        if (s.mode && s.mode != gantt.config.drag_mode.ignore && gantt.config["drag_" + s.mode]) {
                            if (n = gantt.locate(e),
                            i = dhtmlx.copy(gantt.getTask(n) || {}),
                            gantt._is_readonly(i))
                                return this.clear_drag_state(),
                                !1;
                            if (gantt._is_flex_task(i) && s.mode != gantt.config.drag_mode.progress)
                            ...
                            this.clear_drag_state();
                    else if (gantt.checkEvent("onMouseDown") && gantt.callEvent("onMouseDown", [a.split(" ")[0]]) && e.parentNode)
        ...
        _fix_dnd_scale_time: function(t, e) {
            ...
            var a = gantt._tasks.unit
              , s = gantt._tasks.step;
            gantt.config.round_dnd_dates || (a = "minute",
            s = gantt.config.time_step),
            e.mode == gantt.config.drag_mode.resize ? e.left ? (t.start_date = gantt.roundDate({
                date: t.start_date,
                unit: a,
                step: s
            }),
        ...
        on_mouse_up: function(t) {
            ...
            if (e.mode && e.id) {
                ...
                if (gantt.config.work_time && gantt.config.correct_work_time && this._fix_working_times(n, e),
                this._fix_dnd_scale_time(n, e),
                gantt._init_task_timing(n),
                this._fireEvent("before_finish", e.mode, [e.id, e.mode, dhtmlx.copy(e.obj), t])) {
                    var i = e.id;
                    gantt._init_task_timing(n),
                    this._fireEvent("after_finish", e.mode, [i, e.mode, t]),
                    this.clear_drag_state(),
                    gantt.updateTask(n.id)
                } else
                    e.obj._dhx_changed = !1,
                    dhtmlx.mixin(n, e.obj, !0),
                    gantt.updateTask(n.id)
            }
            this.clear_drag_state()
        },
        _get_drag_mode: function(t) {
            ...
            case "gantt_task_drag":
                a.mode = e.resize,
                n[1] && -1 !== n[1].indexOf("left", n[1].length - "left".length) ? a.left = !0 : a.left = !1;
                break;
        ...
        _fireEvent: function(t, e, n) {
            ...
            dhtmlx.assert(n, "Invalid event arguments"),
            gantt.checkEvent(i) ? gantt.callEvent(i, n) : !0
        }
    },
    ...
    gantt._render_link = function(t) {
        for (var e = this.getLink(t), n = gantt._get_link_renderers(), i = 0; i < n.length; i++)
            n[i].render_item(e)
    }
    ,
    ...
    gantt._render_link_element = function(t) {
        ...
        r && (s += " " + r),
        this.config.highlight_critical_path && this.isCriticalLink && this.isCriticalLink(t) && (s += " gantt_critical_link"),
        a.className = s,
        a.setAttribute(gantt.config.link_attribute, t.id);
        for (var o = 0; o < i.length; o++) {
            o == i.length - 1 && (i[o].size -= gantt.config.link_arrow_size);
            var d = n.render_line(i[o], i[o + 1]);
            t.color && (d.firstChild.style.backgroundColor = t.color),
            a.appendChild(d)
        }
        var _ = i[i.length - 1].direction
          , l = gantt._render_link_arrow(e[e.length - 1], _);
        return t.color && (l.style.borderColor = t.color),
        a.appendChild(l),
        a
    }
    ,
    gantt._render_link_arrow = function(t, e) {
        ...
        return n.style.cssText = ["top:" + a + "px", "left:" + s + "px"].join(";"),
        n.className = d,
        n
    }
    ,
    gantt._drawer = {
        ...
        get_wrapper_sizes: function(t) {
            var e, n = gantt.config.link_wrapper_width, i = (gantt.config.link_line_width,
        ...
        get_line_sizes: function(t) {
            var e, n = gantt.config.link_line_width, i = gantt.config.link_wrapper_width, a = t.size + n;
            switch (t.direction) {
            case this.dirs.left:
            case this.dirs.right:
                e = {
        ...
        render_line: function(t) {
            ...
            n.style.cssText = ["top:" + e.top + "px", "left:" + e.left + "px", "height:" + e.height + "px", "width:" + e.width + "px"].join(";"),
            n.className = "gantt_line_wrapper";
            var i = this.get_line_sizes(t)
              , a = document.createElement("div");
            return a.style.cssText = ["height:" + i.height + "px", "width:" + i.width + "px", "margin-top:" + i.marginTop + "px", "margin-left:" + i.marginLeft + "px"].join(";"),
    ...
    gantt._path_builder = {
        ...
        point: function(t) {
            return t ? (this.path.push(dhtmlx.copy(t)),
            t) : this.current()
        },
        ...
        get_points: function(t) {
            ...
            if (t.type == gantt.config.links.start_to_start)
                ...
                o ? (this.point_to(s.down, i),
                this.point_to(s.right, a)) : (this.point_to(s.right, a),
                this.point_to(s.down, i)),
                ...
                o)
                    a -= r,
                    this.point_to(s.down, i),
                    this.point_to(s.right, a);
                else {
                    a -= 2 * r;
                    var d = i > 0 ? 1 : -1;
                    this.point_to(s.down, d * (n.row_height / 2)),
                    this.point_to(s.right, a),
                    this.point_to(s.down, d * (Math.abs(i) - n.row_height / 2)),
                    this.point_to(s.right, r)
                }
            else if (t.type == gantt.config.links.finish_to_finish)
                this.point_to(s.right, r),
                o ? (this.point_to(s.right, a),
                this.point_to(s.down, i)) : (this.point_to(s.down, i),
                this.point_to(s.right, a)),
                this.point_to(s.left, r);
        ...
        get_endpoint: function(t) {
            var e = gantt.config.links
              , n = !1
              , i = !1;
            t.type == e.start_to_start ? n = i = !0 : t.type == e.finish_to_finish ? n = i = !1 : t.type == e.finish_to_start ? (n = !1,
            i = !0) : t.type == e.start_to_finish ? (n = !0,
            i = !1) : dhtmlx.assert(!1, "Invalid link type");
    ...
    gantt._init_links_dnd = function() {
        function t(t, e, n) {
            ...
            return i.y += gantt._get_task_height() / 2,
            n = n || 0,
            i.x += (e ? -1 : 1) * n,
            i
        }
        ...
        function a() {
            ...
            gantt._link_target_task_start = !0
        }
        function s(t, e, n, a) {
            var s = d()
              , _ = i()
            ...
            if (h = Math.max(0, h - 3)) {
                ...
                var u = Math.sin(c)
                  ...
                  , p = Math.round(e)
                  , v = Math.round(t)
                  , m = ["-webkit-transform: rotate(" + c + "rad)", "-moz-transform: rotate(" + c + "rad)", "-ms-transform: rotate(" + c + "rad)", "-o-transform: rotate(" + c + "rad)", "transform: rotate(" + c + "rad)", "width:" + Math.round(h) + "px"];
        ...
        function d() {
            ...
            gantt.$task_links.appendChild(l._direction)),
            l._direction
        }
        function _() {
            l._direction && (l._direction.parentNode && l._direction.parentNode.removeChild(l._direction),
            l._direction = null)
        }
        ...
        l.attachEvent("onBeforeDragStart", dhtmlx.bind(function(e, n) {
            var i = n.target || n.srcElement;
            if (a(),
            gantt.getState().drag_id)
                return !1;
            if (gantt._locate_css(i, c)) {
                gantt._locate_css(i, h) && (gantt._link_source_task_start = !0);
                var s = gantt._link_source_task = this.locate(n)
                  , r = gantt.getTask(s);
                if (gantt._is_readonly(r))
                    return a(),
                    !1;
                var o = 0;
                return gantt._get_safe_type(r.type) == gantt.config.types.milestone && (o = (gantt._get_visible_milestone_width() - gantt._get_milestone_width()) / 2),
                this._dir_start = t(r, !!gantt._link_source_task_start, o),
                !0
            }
            return !1
        }, this)),
        l.attachEvent("onAfterDragStart", dhtmlx.bind(function(t, n) {
            e(l.config.marker)
        }, this)),
        l.attachEvent("onDragMove", dhtmlx.bind(function(i, a) {
            var r = l.config
              , o = l.getPosition(a);
            n(r.marker, o);
            var d = gantt._is_link_drop_area(a)
              ...
              , f = gantt.locate(a)
              , p = !0;
            if (d && (p = !gantt._locate_css(a, g),
            d = !!f),
            gantt._link_target_task = f,
            gantt._link_landing = d,
            gantt._link_target_task_start = p,
            d) {
                var v = gantt.getTask(f)
                  , m = gantt._locate_css(a, u)
                  , k = 0;
                m && (k = Math.floor(m.offsetWidth / 2)),
                this._dir_end = t(v, !!gantt._link_target_task_start, k)
            } else
                this._dir_end = gantt._get_mouse_pos(a);
            var x = !(h == d && _ == f && c == p);
        ...
        l.attachEvent("onDragEnd", dhtmlx.bind(function() {
            var t = i();
    ...
    gantt._init_tasks = function() {
        ...
        this._click.gantt_scale_cell = dhtmlx.bind(function(t, e) {
            var n = gantt._get_mouse_pos(t)
        ...
        this._dbl_click.gantt_task_link = dhtmlx.bind(function(t, e, n) {
            var e = this.locate(t, gantt.config.link_attribute);
            this._delete_link_handler(e, t)
        }, this),
        this._dbl_click.gantt_link_point = dhtmlx.bind(function(t, e, n) {
            var e = this.locate(t)
              , i = this.getTask(e)
              , a = null;
            return n.parentNode && gantt._getClassName(n.parentNode) && (a = gantt._getClassName(n.parentNode).indexOf("_left") > -1 ? i.$target[0] : i.$source[0]),
            a && this._delete_link_handler(a, t),
            !1
        }, this),
        ...
        this._linkRenderer = this._link_layers.getRenderer(e),
        ...
        this._onTaskIdChange = this.attachEvent("onTaskIdChange", function(e, n) {
            var i = this._get_task_renderers();
            t(i, e, n, this.getTask(n))
        }),
        this._onLinkIdChange && this.detachEvent(this._onLinkIdChange),
        this._onLinkIdChange = this.attachEvent("onLinkIdChange", function(e, n) {
    ...
    gantt._filter_task = function(t, e) {
        ...
        i = this.config.end_date.valueOf(),
        +e.start_date > i || +e.end_date < +n) ? !1 : !0
    }
    ,
    ...
    gantt._get_links_data = function() {
        ...
        for (var e in this._lpull)
            t.push(this._lpull[e]);
        return t
    }
    ,
    gantt._render_data = function() {
        if (this.callEvent("onBeforeDataRender", []),
        this._is_render_active()) {
            this._sync_order(),
            this._update_layout_sizes(),
            this.config.static_background && this._render_bg_canvas();
            for (var t = this._get_tasks_data(), e = this._get_task_renderers(), n = 0; n < e.length; n++)
                e[n].render_items(t);
    ...
    gantt._update_layout_sizes = function() {
        ...
        if (this._is_grid_visible()) {
            for (var s = this.getGridColumns(), r = 0, n = 0; n < s.length; n++)
                r += s[n].width;
    ...
    gantt._init_tasks_range = function() {
        ...
        if (this.config.start_date && this.config.end_date)
            return this._min_date = this.date[t + "_start"](new Date(this.config.start_date)),
            void (this._max_date = this.date[t + "_start"](new Date(this.config.end_date)));
        this._get_tasks_data();
        var e = this.getSubtaskDates();
        this._min_date = e.start_date,
        this._max_date = e.end_date,
        this._max_date && this._max_date || (this._min_date = new Date,
    ...
    gantt._prepare_scale_html = function(t) {
        var e = []
          ...
          , i = null
          , a = null;
        (t.template || t.date) && (i = t.template || this.date.date_to_str(t.date)),
        a = t.css || function() {}
        ,
        !t.css && this.config.inherit_scale_class && (a = gantt.templates.scale_cell_class);
    ...
    gantt._render_tasks_scales = function() {
        ...
        if (this._is_chart_visible()) {
            ...
            for (var r = this._get_resize_options(), o = r.x ? Math.max(this.config.autosize_min_width, 0) : this.$task.offsetWidth, d = a.prepareConfigs(s, this.config.min_column_width, o, i), _ = this._tasks = d[d.length - 1], l = [], h = this.templates.scale_row_class, g = 0; g < d.length; g++) {
                var c = "gantt_scale_line"
                  , u = h(d[g]);
                u && (c += " " + u),
                l.push('<div class="' + c + '" style="height:' + d[g].height + "px;line-height:" + d[g].height + 'px">' + this._prepare_scale_html(d[g]) + "</div>")
            }
            t = l.join(""),
            e = _.full_width + this.$scroll_ver.offsetWidth + "px",
            n = _.full_width + "px",
            i += "px"
        }
    ...
    gantt._render_bg_line = function(t) {
        ...
        if (gantt.config.show_task_cells)
            for (var a = 0; n > a; a++) {
                ...
                if (s > 0) {
                    ...
                    o.style.width = s + "px",
                    r = "gantt_task_cell" + (a == n - 1 ? " gantt_last_cell" : ""),
                    _ = this.templates.task_cell_class(t, e.trace_x[a]),
                    _ && (r += " " + _),
                    o.className = r,
                    i.appendChild(o)
                }
        ...
        return this.getState().selected_task == t.id && (l += " gantt_selected"),
        i.className = l,
        i.style.height = gantt.config.row_height + "px",
    ...
    gantt._adjust_scales = function() {
        if (this.config.fit_tasks) {
            var t = +this._min_date
              , e = +this._max_date;
            if (this._init_tasks_range(),
            +this._min_date != t || +this._max_date != e)
                return this.render(),
    ...
    gantt.refreshTask = function(t, e) {
        if (this._is_render_active()) {
            ...
            if (i && this.isTaskVisible(t)) {
                ...
                if (void 0 !== e && !e)
                    return;
                for (var a = 0; a < i.$source.length; a++)
                    gantt.refreshLink(i.$source[a]);
                for (var a = 0; a < i.$target.length; a++)
                    gantt.refreshLink(i.$target[a])
            } else
                this._render_data()
        }
    }
    ...
    gantt._combine_item_class = function(t, e, n) {
        ...
        this._get_safe_type(s.type) == this.config.types.project && i.push("gantt_project"),
        this._is_flex_task(s) && i.push("gantt_dependent_task"),
        this.config.select_task && n == a.selected_task && i.push("gantt_selected"),
        n == a.drag_id && (i.push("gantt_drag_" + a.drag_mode),
        a.touch_drag && i.push("gantt_touch_" + a.drag_mode));
        var r = gantt._get_link_state();
        if (r.link_source_id == n && i.push("gantt_link_source"),
        r.link_target_id == n && i.push("gantt_link_target"),
        this.config.highlight_critical_path && this.isCriticalTask && this.isCriticalTask(s) && i.push("gantt_critical_task"),
        r.link_landing_area && r.link_target_id && r.link_source_id && r.link_target_id != r.link_source_id) {
            var o = r.link_source_id
              ...
              , h = "";
            h = l ? _ ? "link_start_allow" : "link_finish_allow" : _ ? "link_start_deny" : "link_finish_deny",
            i.push(h)
        }
        return i.join(" ")
    }
    ...
    gantt._render_pair = function(t, e, n, i) {
        var a = gantt.getState();
        +n.end_date <= +a.max_date && t.appendChild(i(e + " task_right")),
        +n.start_date >= +a.min_date && t.appendChild(i(e + " task_left"))
    }
    ,
    ...
    gantt._task_default_render = function(t) {
        if (!this._isAllowedUnscheduledTask(t)) {
            ...
            t.textColor && (d.style.color = t.textColor),
            s.appendChild(d);
            ...
            t.textColor && l.push("color:" + t.textColor),
            s.style.cssText = l.join(";");
            var h = this._render_leftside_content(t);
            return h && s.appendChild(h),
            h = this._render_rightside_content(t),
            h && s.appendChild(h),
            this._is_readonly(t) || (n.drag_resize && !this._is_flex_task(t) && o != this.config.types.milestone && gantt._render_pair(s, "gantt_task_drag", t, function(t) {
                var e = document.createElement("div");
            ...
            n.drag_links && this.config.show_links && gantt._render_pair(s, "gantt_link_control", t, function(t) {
                var e = document.createElement("div");
                e.className = t,
                e.style.cssText = ["height:" + i + "px", "line-height:" + i + "px"].join(";");
                var n = document.createElement("div");
    ...
    gantt._render_task_element = function(t) {
        ...
        return n || (n = i),
        n.call(this, t, dhtmlx.bind(i, this))
    }
    ,
    ...
    gantt._render_task_content = function(t, e) {
        ...
        n.className = "gantt_task_content",
        n
    }
    ,
    gantt._render_task_progress = function(t, e, n) {
        ...
        var a = document.createElement("div")
          , s = Math.round(n * i);
        if (s = Math.min(n, s),
        t.progressColor && (a.style.backgroundColor = t.progressColor,
        a.style.opacity = 1),
        a.style.width = s + "px",
        a.className = "gantt_task_progress",
        a.innerHTML = this.templates.progress_text(t.start_date, t.end_date, t),
        e.appendChild(a),
        this.config.drag_progress && !gantt._is_readonly(t)) {
            var r = document.createElement("div");
            r.style.left = s + "px",
            r.className = "gantt_task_progress_drag",
            a.appendChild(r),
            e.appendChild(r)
        }
    }
    ...
    gantt.dateFromPos = function(t) {
        var e = this._tasks;
        if (0 > t || t > e.full_width || !e.full_width)
            return null;
    ...
    gantt.posFromDate = function(t) {
        ...
        i && (a += n < gantt._tasks.width.length ? gantt._tasks.width[n] * (i % 1) : 1),
        a
    }
    ,
    gantt._day_index_by_date = function(t) {
        ...
        if (e >= this._max_date)
            return n.length;
        for (var a = gantt._findBinary(n, e), s = +gantt._tasks.trace_x[a]; i[s]; )
            s = gantt._tasks.trace_x[++a];
    ...
    gantt._get_mouse_pos = function(t) {
        ...
        return e.x = e.x - i.x + gantt.$task_data.scrollLeft,
        e.y = e.y - i.y + gantt.$task_data.scrollTop,
        e
    }
    ,
    ...
    gantt._task_renderer = function(t, e, n, i) {
        ...
        this._task_area_renderers[t] ? this._task_area_renderers[t] : (e || dhtmlx.assert(!1, "Invalid renderer call"),
        ...
        this._task_area_renderers[t] = {
            render_item: function(a, s) {
                ...
                if (s = s || n,
                i && !i(a))
                    return void this.remove_item(a.id);
                var o = e.call(gantt, a);
                o && (r[a.id] ? this.replace_item(a.id, o) : (r[a.id] = o,
                s.appendChild(o)))
            },
            clear: function(e) {
            ...
            unload: function() {
                this.clear(),
                delete gantt._task_area_renderers[t],
                delete gantt._task_area_pulls[t]
            }
        },
        this._task_area_renderers[t])
    }
    ...
    gantt._clear_renderers = function() {
        for (var t in this._task_area_renderers)
            this._task_renderer(t).unload()
    }
    ,
    gantt._render_bg_canvas = function(t) {
        var e = gantt._tasks
          , n = gantt.$task_bg
        ...
        if (i.getContext) {
            ...
            r.className = "gantt_task_row",
            o.className = "gantt_task_cell",
            ...
            d.lineTo(s, a),
            d.lineWidth = 1,
            d.strokeStyle = getComputedStyle(r).getPropertyValue("border-bottom-color") || "#ebebeb",
            d.stroke(),
            d.beginPath(),
            d.moveTo(s, a),
            d.lineTo(s, 0),
            d.lineWidth = 1,
            d.strokeStyle = getComputedStyle(o).getPropertyValue("border-right-color") || "#ebebeb",
            d.stroke(),
            e.fill_img = i.toDataURL(),
            n.style.height = a * gantt._order.length + "px",
            n.style.backgroundImage = "url(" + e.fill_img + ")",
            n.removeChild(r)
        }
    }
    ,
    ...
    gantt._layers = {
        ...
        create: function(t, e) {
            return {
                ...
                add: function(t) {
                    if (t && this.tempCollection.push(t),
                    this.container())
                        for (var n = this.container(), i = this.tempCollection, a = 0; a < i.length; a++) {
                            ...
                            this.tempCollection.splice(a, 1),
                            a--
                        }
                },
                remove: function(t) {
    ...
    gantt._add_generic_layer = function(t, e) {
        return function(n) {
            ...
            n = gantt._layers.prepareConfig(n),
            t.add(n),
            n.id
        }
    }
    ...
    gantt.load = function(t, e, n) {
        ...
        a = n) : "string" == typeof arguments[1] ? i = arguments[1] : "function" == typeof arguments[1] && (a = arguments[1]),
        this._load_type = i,
        dhx4.ajax.get(t, dhtmlx.bind(function(t) {
            this.on_load(t, i),
    ...
    gantt.on_load = function(t, e) {
        ...
        e || (e = "json"),
        dhtmlx.assert(this[e], "Invalid data type:'" + e + "'");
    ...
    gantt._sync_order_item = function(t) {
        if (t.id && this._filter_task(t.id, t) && this.callEvent("onBeforeTaskDisplay", [t.id, t]) && this._order.push(t.id),
        t.$open) {
            var e = this.getChildren(t.id);
            if (e)
                for (var n = 0; n < e.length; n++)
                    this._sync_order_item(this._pull[e[n]])
        }
    }
    ,
    ...
    gantt.eachTask = function(t, e, n) {
        ...
        if (i)
            for (var a = 0; a < i.length; a++) {
                ...
                t.call(n, s),
                this.hasChild(s.id) && this.eachTask(t, s.id, n)
            }
    }
    ,
    gantt.json = {
        parse: function(data) {
            return dhtmlx.assert(data, "Invalid data"),
            "string" == typeof data && (window.JSON ? data = JSON.parse(data) : (gantt._temp = eval("(" + data + ")"),
            data = gantt._temp || {},
            gantt._temp = null)),
            data.dhx_security && (dhtmlx.security_key = data.dhx_security),
            data
        },
        ...
        serialize: function() {
            ...
            gantt.eachTask(function(e) {
                gantt.resetProjectDates(e),
                t.push(this._copyObject(e))
            }, gantt.config.root_id, this);
            for (var n in gantt._lpull)
                e.push(this._copyLink(gantt._lpull[n]));
            return {
                data: t,
                links: e
            }
    ...
    gantt.xml = {
        _xmlNodeToJSON: function(t, e) {
            for (var n = {}, i = 0; i < t.attributes.length; i++)
                n[t.attributes[i].name] = t.attributes[i].value;
            if (!e) {
            ...
            for (var e = {}, n = dhx4.ajax.xpath("//coll_options", t), i = 0; i < n.length; i++)
                for (var a = n[i].getAttribute("for"), s = e[a] = [], r = dhx4.ajax.xpath(".//item", n[i]), o = 0; o < r.length; o++) {
                    for (var d = r[o], _ = d.attributes, l = {
                        ...
                        var g = _[h];
                        "value" != g.nodeName && "label" != g.nodeName && (l[g.nodeName] = g.nodeValue)
                    }
                    s.push(l)
                }
            return e
        ...
        _getXML: function(t, e, n) {
            n = n || "data",
            e.getXMLTopNode || (e = dhx4.ajax.parse(e));
            var i = dhx4.ajax.xmltop(n, e.xmlDoc);
            if (i.tagName != n)
                throw "Invalid XML data";
            var a = i.getAttribute("dhx_security");
            return a && (dhtmlx.security_key = a),
            i
        },
        parse: function(t, e) {
            e = this._getXML(t, e);
            for (var n = {}, i = n.data = [], a = dhx4.ajax.xpath("//task", e), s = 0; s < a.length; s++)
                i[s] = this._xmlNodeToJSON(a[s]);
            return n.collections = this._getCollections(e),
            n
        },
        _copyLink: function(t) {
        ...
        serialize: function() {
            for (var t = [], e = [], n = gantt.json.serialize(), i = 0, a = n.data.length; a > i; i++)
                t.push(this._copyObject(n.data[i]));
            for (var i = 0, a = n.links.length; a > i; i++)
                e.push(this._copyLink(n.links[i]));
    ...
    gantt.oldxml = {
        parse: function(t, e) {
            ...
            for (var n = {
                ...
                "project" == r.tagName ? i[s].parent = "project-" + r.getAttribute("id") : i[s].parent = r.parentNode.getAttribute("id")
            }
            ...
            for (var s = 0; s < i.length; s++) {
                var o = i[s];
                o.start_date = o.startdate || o.est,
                o.end_date = o.enddate,
                o.text = o.name,
                o.duration = o.duration / 8,
                o.open = 1,
                o.duration || o.end_date || (o.duration = 1),
                o.predecessortasks && n.collections.links.push({
                    target: o.id,
    ...
    gantt._working_time_helper = {
        ...
        _working_units_cache: {
            ...
            get: function(t, e) {
                ...
                var n = this._cache
                  , i = e.getTime()
                  , a = -1;
                return n && n[t] && void 0 !== n[t][i] && (a = n[t][i]),
                a
            },
            put: function(t, e, n) {
                if (!t || !e)
        ...
        _timestamp: function(t) {
            var e = null;
            return t.day || 0 === t.day ? e = t.day : t.date && (e = gantt.date.date_part(new Date(t.date)).valueOf()),
            e
        },
        set_time: function(t) {
        ...
        is_working_unit: function(t, e, n) {
            ...
            return -1 == i && (i = this._check_is_working_unit(t, e, n),
            this._working_units_cache.put(e, t, i)),
            i
        },
        _check_is_working_unit: function(t, e, n) {
            return void 0 === n && (n = this._get_unit_order(e)),
            void 0 === n ? !1 : n && !this.is_working_unit(t, this.units[n - 1], n - 1) ? !1 : this["is_work_" + e] ? this["is_work_" + e](t) : !0
        },
        ...
        get_working_hours: function(t) {
            var e = this._timestamp({
              ...
              , n = !0;
            return void 0 !== this.dates[e] ? n = this.dates[e] : void 0 !== this.dates[t.getDay()] && (n = this.dates[t.getDay()]),
            n === !0 ? this.hours : n ? n : []
        },
        get_work_units_between: function(t, e, n, i) {
            if (!n)
                return !1;
            for (var a = new Date(t), s = new Date(e), i = i || 1, r = 0; a.valueOf() < s.valueOf(); )
                this.is_working_unit(a, n) && r++,
        ...
        add_worktime: function(t, e, n, i) {
            ...
            if (gantt.config.work_time) {
                for (; e > s; ) {
                    ...
                    this.is_working_unit(i > 0 ? a : r, n) && s++,
                    a = r
                }
                return a
            }
        ...
        get_closest_worktime: function(t) {
            if (this.is_working_unit(t.date, t.unit))
                return t.date;
            var e = t.unit
            ...
            for ("past" == t.dir && (_ = -1); !this.is_working_unit(n, e); ) {
                ...
                if (n = gantt.date.add(n, _, e),
                n = gantt._correct_dst_change(n, l, _, e),
                gantt.date[e + "_start"] && (n = gantt.date[e + "_start"](n)),
                d && (s ? i = n : a = n),
                s = !s,
                o++,
                o > r)
                    return dhtmlx.assert(!1, "Invalid working time check"),
                    !1
            }
            return (n == a || "past" == t.dir) && (n = gantt.date.add(n, 1, e)),
            n
        }
    },
    gantt.getTask = function(t) {
        return dhtmlx.assert(t, "Invalid argument for gantt.getTask"),
        dhtmlx.assert(this._pull[t], "Task not found id=" + t),
        this._pull[t]
    }
    ,
    gantt.getTaskByTime = function(t, e) {
        ...
        if (t || e) {
            ...
            for (var a in n) {
                var s = n[a];
                +s.start_date < e && +s.end_date > t && i.push(s)
            }
        } else
            for (var a in n)
                i.push(n[a]);
    ...
    gantt.isTaskVisible = function(t) {
        if (!this._pull[t])
            return !1;
        var e = this._pull[t];
        if (!(+e.start_date < +this._max_date && +e.end_date > +this._min_date || gantt._isAllowedUnscheduledTask(e)))
            return !1;
        for (var n = 0, i = this._order.length; i > n; n++)
            if (this._order[n] == t)
                return !0;
        return !1
    }
    ...
    gantt.updateTask = function(t, e) {
        return dhtmlx.defined(e) || (e = this.getTask(t)),
        this.callEvent("onBeforeTaskUpdate", [t, e]) === !1 ? !1 : (this._pull[e.id] = e,
        this._is_parent_sync(e) || this._resync_parent(e),
        this._isAllowedUnscheduledTask(e) && (this._init_task(e),
        this._sync_links()),
    ...
    gantt._add_branch = function(t, e) {
        ...
        a || (1 * e == e ? i.splice(e, 0, t.id) : i.push(t.id)),
        this._sync_parent(t)
    }
    ,
    ...
    gantt.addTask = function(t, e, n) {
        return dhtmlx.defined(e) || (e = this.getParent(t) || 0),
        this.isTaskExists(e) || (e = 0),
        this.setParent(t, e),
        t = this._init_task(t),
        this.callEvent("onBeforeTaskAdd", [t.id, t]) === !1 ? !1 : (this._pull[t.id] = t,
    ...
    gantt._default_task_date = function(t, e) {
        ...
        if (n)
            ...
            var a = this._order[0];
            i = a ? this.getTask(a).start_date ? this.getTask(a).start_date : this.getTask(a).end_date ? this.calculateEndDate(this.getTask(a).end_date, -this.config.duration_step) : "" : this.config.start_date || this.getState().min_date;
        }
        return dhtmlx.assert(i, "Invalid dates"),
        new Date(i)
    }
    ,
    gantt._set_default_task_timing = function(t) {
        t.start_date = t.start_date || gantt._default_task_date(t, this.getParent(t)),
    ...
    gantt.createTask = function(t, e, n) {
        ...
        return this.callEvent("onTaskCreated", [t]) ? (this.config.details_on_create ? (t.$new = !0,
        this._pull[t.id] = this._init_task(t),
        this._add_branch(t, n),
        t.$level = this.calculateTaskLevel(t),
        this.selectTask(t.id),
        this.refreshData(),
        this.showLightbox(t.id)) : this.addTask(t, e, n) && (this.showTask(t.id),
        this.selectTask(t.id)),
        t.id) : null
    }
    ,
    ...
    gantt._getChildLinks = function(t) {
        ...
        if (!e)
            return [];
        for (var n = e.$source.concat(e.$target), i = this.getChildren(e.id), a = 0; a < i.length; a++)
            n = n.concat(this._getChildLinks(i[a]));
    ...
    gantt._getTaskTree = function(t) {
        ...
        if (!e)
            return [];
        for (var n = [], i = this.getChildren(e.id), a = 0; a < i.length; a++)
            n.push(i[a]),
            n = n.concat(this._getTaskTree(i[a]));
        return n
    }
    ,
    ...
    gantt._deleteRelatedTasks = function(t, e) {
        ...
        for (var a = this._getTaskTree(t), s = 0; s < a.length; s++) {
            var r = a[s];
            this._unset_task(r),
            n && this._dp.setUpdated(r, !0, "deleted")
        }
        n && this._dp.setUpdateMode(i);
    }
    ,
    ...
    gantt._deleteTask = function(t, e) {
        ...
        if (!e && this.callEvent("onBeforeTaskDelete", [t, n]) === !1)
            return !1;
        var i = gantt._getChildLinks(t);
        return this._deleteRelatedTasks(t, e),
        this._deleteRelatedLinks(i, e),
        this._unset_task(t),
        e || (this.callEvent("onAfterTaskDelete", [t, n]),
        this.refreshData()),
        !0
    }
    ,
    ...
    gantt._update_flags = function(t, e) {
        ...
        this._tasks_dnd.drag && (this._tasks_dnd.drag.id = null)) : (this._lightbox_id == t && (this._lightbox_id = e),
        this._selected_task == t && (this._selected_task = e),
        this._tasks_dnd.drag && this._tasks_dnd.drag.id == t && (this._tasks_dnd.drag.id = e))
    }
    ,
    ...
    gantt.getClosestWorkTime = function(t) {
        ...
        t.dir = t.dir || "any",
        t.unit = t.unit || this.config.duration_unit,
    ...
    gantt._init_task = function(t) {
        return dhtmlx.defined(t.id) || (t.id = dhtmlx.uid()),
        t.start_date && (t.start_date = gantt.date.parseDate(t.start_date, "xml_date")),
        t.end_date && (t.end_date = gantt.date.parseDate(t.end_date, "xml_date")),
        t.start_date ? !t.end_date && t.duration && (t.end_date = this.calculateEndDate(t.start_date, t.duration)) : t.end_date && void 0 !== t.duration && (t.start_date = this.calculateEndDate(t.end_date, -t.duration)),
        this._isAllowedUnscheduledTask(t) && this._set_default_task_timing(t),
        gantt._init_task_timing(t),
        t.start_date && t.end_date && gantt.correctTaskWorkTime(t),
        t.$source = [],
        t.$target = [],
        void 0 === t.parent && this.setParent(t, this.config.root_id),
        dhtmlx.defined(t.$open) || (t.$open = dhtmlx.defined(t.open) ? t.open : this.config.open_tree_initially),
        t.$level = this.calculateTaskLevel(t),
        t
    }
    ,
    gantt._init_task_timing = function(t) {
        ...
        delete t.$no_start,
        t.$rendered_type = e),
        void 0 !== t.$no_end && void 0 !== t.$no_start || e == this.config.types.milestone || (e == this.config.types.project ? (t.$no_end = t.$no_start = !0,
        this._set_default_task_timing(t)) : (t.$no_end = !(t.end_date || t.duration),
    ...
    gantt._assign_project_dates = function(t, e, n) {
        ...
        t.$no_end && (n && n != -(1 / 0) ? t.end_date = new Date(n) : t.end_date = this.calculateEndDate(t.start_date, this.config.duration_step)),
        (t.$no_start || t.$no_end) && this._init_task_timing(t)
    }
    ,
    gantt._update_parents = function(t, e) {
        if (t) {
            for (var n = this.getTask(t), i = this.getParent(n); !n.$no_end && !n.$no_start && i && this.isTaskExists(i); )
                n = this.getTask(i),
                i = this.getParent(n);
            (n.$no_start || n.$no_end) && (gantt.resetProjectDates(n),
            e || this.refreshTask(n.id, !0)),
            i && this.isTaskExists(i) && this._update_parents(i, e)
        }
    }
    ,
    gantt.isChildOf = function(t, e) {
        if (!this.isTaskExists(t))
            return !1;
        if (e === this.config.root_id)
            return this.isTaskExists(t);
    ...
    gantt.roundDate = function(t) {
        ...
        var e, n, i = t.date, a = t.step, s = t.unit;
        if (s == gantt._tasks.unit && a == gantt._tasks.step && +i >= +gantt._min_date && +i <= +gantt._max_date) {
            ...
            n = new Date(gantt._tasks.trace_x[r]),
            e = new Date(n),
            gantt._tasks.trace_x[r + 1] && (e = new Date(gantt._tasks.trace_x[r + 1]))
        } else {
            for (e = gantt.date[s + "_start"](new Date(this._min_date)); +i > +e; ) {
                e = gantt.date[s + "_start"](gantt.date.add(e, a, s));
                var o = e.getTimezoneOffset();
                e = gantt.date.add(e, a, s),
                e = gantt._correct_dst_change(e, o, e, s),
                gantt.date[s + "_start"] && (e = gantt.date[s + "_start"](e))
            }
    ...
    gantt.attachEvent("onBeforeTaskUpdate", function(t, e) {
        return gantt._init_task_timing(e),
        !0
    }),
    ...
    gantt.calculateTaskLevel = function(t) {
        for (var e = 0; this.getParent(t) && this.isTaskExists(this.getParent(t)); )
            t = this.getTask(this.getParent(t)),
            e++;
        return e
    }
    ,
    ...
    gantt.getParent = function(t) {
        var e = null;
        return t.id ? e = t : this.isTaskExists(t) && (e = gantt.getTask(t)),
        this._get_parent_id(e)
    }
    ,
    ...
    gantt._dp_init = function(t) {
        t.setTransactionMode("POST", !0),
        t.serverProcessor += (-1 != t.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true",
        t._serverProcessor = t.serverProcessor,
        t.styles = {
        ...
        t.setGanttMode = function(e) {
            ...
            t._in_progress = i._in_progress,
            t._invalid = i._invalid,
            t.updatedRows = i.updatedRows,
            t.modes = n,
            t._ganttMode = e
        }
        ,
        this._sendTaskOrder = function(e, n) {
            n.$drop_target && (t.setGanttMode("tasks"),
        ...
        t.attachEvent("onBeforeDataSending", function() {
            ...
            if ("REST" == this._tMode) {
                ...
                this.serverProcessor = t + window.dhtmlx.url(t) + "gantt_mode=" + this._ganttMode;
            return !0
        }),
        ...
        t.afterUpdate = function() {
            ...
            var i = t._ganttMode
              , a = n.filePath;
            i = "REST" != this._tMode ? -1 != a.indexOf("gantt_mode=links") ? "links" : "tasks" : a.indexOf("/link") > a.indexOf("/task") ? "links" : "tasks",
            t.setGanttMode(i);
            var s = e.apply(t, arguments);
            return t.setGanttMode(i),
            s
        }
        ,
        t._getRowData = dhtmlx.bind(function(e, n) {
            ...
            for (var s in i)
                if ("$" != s.substr(0, 1)) {
                    var r = i[s];
                    r instanceof Date ? a[s] = this.templates.xml_format(r) : null === r ? a[s] = "" : a[s] = r
                }
            return i.$no_start && (i.start_date = "",
            i.duration = ""),
            i.$no_end && (i.end_date = "",
            i.duration = ""),
            a[t.action_param] = this.getUserData(e, t.action_param),
            a
        }, this),
        this._change_id = dhtmlx.bind(function(e, n) {
            "tasks" != t._ganttMode ? this.changeLinkId(e, n) : this.changeTaskId(e, n)
        }, this),
        this._row_style = function(e, n) {
            if ("tasks" == t._ganttMode && gantt.isTaskExists(e)) {
                var i = gantt.getTask(e);
                i.$dataprocessor_class = n,
                gantt.refreshTask(e)
            }
        }
        ,
    ...
    gantt._sync_links = function() {
        for (var t in this._pull)
            this._pull[t].$source = [],
            this._pull[t].$target = [];
        for (var t in this._lpull) {
            var e = this._lpull[t];
            this._pull[e.source] && this._pull[e.source].$source.push(t),
            this._pull[e.target] && this._pull[e.target].$target.push(t)
        }
    }
    ,
    gantt.getLink = function(t) {
        return dhtmlx.assert(this._lpull[t], "Link doesn't exist"),
        this._lpull[t]
    }
    ,
    gantt.getLinks = function() {
        var t = [];
        for (var e in gantt._lpull)
            t.push(gantt._lpull[e]);
        return t
    }
    ,
    ...
    gantt.addLink = function(t) {
        ...
        this.callEvent("onBeforeLinkAdd", [t.id, t]) === !1 ? !1 : (this._lpull[t.id] = t,
        this._sync_links(),
    ...
    gantt.updateLink = function(t, e) {
        return dhtmlx.defined(e) || (e = this.getLink(t)),
        this.callEvent("onBeforeLinkUpdate", [t, e]) === !1 ? !1 : (this._lpull[t] = e,
        this._sync_links(),
        this._render_link(t),
    ...
    gantt._deleteLink = function(t, e) {
        ...
        return e || this.callEvent("onBeforeLinkDelete", [t, n]) !== !1 ? (delete this._lpull[t],
        this._sync_links(),
        this.refreshLink(t),
    ...
    gantt._configure = function(t, e, n) {
        for (var i in e)
            ("undefined" == typeof t[i] || n) && (t[i] = e[i])
    }
    ,
    ...
    gantt._get_skin = function(t) {
        ...
        s[1] && "undefined" == typeof s[1].width && (s[1].width = a._second_column_width),
        s[2] && "undefined" == typeof s[2].width && (s[2].width = a._third_column_width),
        a._lightbox_template && (gantt._lightbox_template = a._lightbox_template),
        gantt.resetLightbox()
    }
    ,
    ...
    gantt._get_timepicker_step = function() {
        if (this.config.round_dnd_dates) {
            ...
            return (e >= 1440 || !this._is_chart_visible()) && (e = this.config.time_step),
            e
        }
    ...
    gantt.getLightbox = function(t) {
        if (void 0 === t && (t = this.getLightboxType()),
        !this._lightbox || this.getLightboxType() != this._get_safe_type(t)) {
            ...
            (gantt.config.wide_form || n) && (e.className += " gantt_cal_light_wide"),
            n && (gantt.config.wide_form = !0,
            ...
            i += "</div>",
            e.innerHTML = i,
            gantt.config.drag_lightbox && (e.firstChild.onmousedown = gantt._ready_to_dnd,
    ...
    gantt._render_sections = function(t) {
        for (var e = "", n = 0; n < t.length; n++) {
            ...
            if (i) {
                ...
                e += "<div id='" + t[n].id + "' class='gantt_cal_lsection'>" + s + this.locale.labels["section_" + t[n].name] + "</div>" + i.render.call(this, t[n]),
                e += "</div>"
            }
        }
        return e
    ...
    gantt._center_lightbox = function(t) {
        if (t) {
            ...
            e ? t.style.top = Math.round(e + Math.max((i - t.offsetHeight) / 2, 0)) + "px" : t.style.top = Math.round(Math.max((i - t.offsetHeight) / 2, 0) + 9) + "px",
            document.documentElement.scrollWidth > document.body.offsetWidth ? t.style.left = Math.round(n + (document.body.offsetWidth - t.offsetWidth) / 2) + "px" : t.style.left = Math.round((document.body.offsetWidth - t.offsetWidth) / 2) + "px"
        }
    }
    ,
    ...
    gantt._init_lightbox_events = function() {
        ...
        gantt.lightbox_events["default"] = function(t, e) {
            if (e.getAttribute("dhx_button"))
                ...
                var n, i, a, s = gantt._getClassName(e);
                -1 != s.indexOf("gantt_custom_button") && (-1 != s.indexOf("gantt_custom_button_") ? (n = e.parentNode.getAttribute("index"),
                a = e.parentNode.parentNode) : (n = e.getAttribute("index"),
                a = e.parentNode,
                e = e.firstChild));
                var r = gantt._get_typed_lightbox_config();
                n && (i = gantt.form_blocks[r[n].type],
                i.button_click(n, e, a, a.nextSibling))
            }
        }
        ,
        dhtmlxEvent(gantt.getLightbox(), "click", function(t) {
            ...
            if (n || (e = e.previousSibling,
            n = gantt._getClassName(e)),
            e && n && 0 === n.indexOf("gantt_btn_set") && (e = e.firstChild,
            n = gantt._getClassName(e)),
            e && n) {
                var i = dhtmlx.defined(gantt.lightbox_events[e.className]) ? gantt.lightbox_events[e.className] : gantt.lightbox_events["default"];
                return i(t, e)
            }
            return !1
        }),
    ...
    gantt._cancel_lightbox = function() {
        ...
        this.callEvent("onLightboxCancel", [this._lightbox_id, t.$new]),
        gantt.isTaskExists(t.id) && t.$new && this._deleteTask(t.id, !0),
        this.refreshData(),
        this.hideLightbox()
    }
    ,
    gantt._save_lightbox = function() {
        ...
        this.addTask(t)) : this.isTaskExists(t.id) && (dhtmlx.mixin(this.getTask(t.id), t, !0),
    ...
    gantt.resetLightbox = function() {
        gantt._lightbox && !gantt._custom_lightbox && gantt._lightbox.parentNode.removeChild(gantt._lightbox),
    ...
    gantt._set_lightbox_values = function(t, e) {
        ...
        gantt.templates.lightbox_header ? (i[1].innerHTML = "",
        i[2].innerHTML = gantt.templates.lightbox_header(n.start_date, n.end_date, n)) : (i[1].innerHTML = this.templates.task_time(n.start_date, n.end_date, n),
        ...
        for (var a = this._get_typed_lightbox_config(this.getLightboxType()), s = 0; s < a.length; s++) {
            ...
            if (this.form_blocks[r.type]) {
                ...
                d.set_value.call(gantt, o, l, n, r),
                r.focus && d.focus.call(gantt, o)
            }
        }
    ...
    gantt._move_while_dnd = function(t) {
        if (gantt._dnd_start_lb) {
            ...
            e.style.top = gantt._lb_start[1] + n[1] - gantt._dnd_start_lb[1] + "px",
            e.style.left = gantt._lb_start[0] + n[0] - gantt._dnd_start_lb[0] + "px"
        }
    }
    ,
    ...
    gantt._finish_dnd = function() {
        gantt._lb_start && (gantt._lb_start = gantt._dnd_start_lb = !1,
    ...
    gantt.form_blocks = {
        getTimePicker: function(t, e) {
            ...
            var i = this.config
              ...
              , s = 1440
              , r = 0;
            gantt.config.limit_time_select && (s = 60 * i.last_hour + 1,
            r = 60 * i.first_hour,
            a.setHours(i.first_hour));
            for (var o = "", d = 0; d < n.length; d++) {
                ...
                switch (_) {
                case "%Y":
                    t._time_format_order[2] = d,
                    t._time_format_order.size++;
                    var h, g, c, u;
                    ...
                    u = u || c + h;
                    for (var f = c; u > f; f++)
                        l += "<option value='" + f + "'>" + f + "</option>";
                    break;
                case "%m":
                    t._time_format_order[1] = d,
                    t._time_format_order.size++;
                    for (var f = 0; 12 > f; f++)
                        l += "<option value='" + f + "'>" + this.locale.date.month_full[f] + "</option>";
                    break;
                case "%d":
                    t._time_format_order[0] = d,
                    t._time_format_order.size++;
                    for (var f = 1; 32 > f; f++)
                        l += "<option value='" + f + "'>" + f + "</option>";
                    break;
                case "%H:%i":
                    t._time_format_order[3] = d,
                    t._time_format_order.size++;
                    var f = r
                      , p = a.getDate();
                    for (t._time_values = []; s > f; ) {
                        var v = this.templates.time_picker(a);
                        l += "<option value='" + f + "'>" + v + "</option>",
                        t._time_values.push(f),
                        a.setTime(a.valueOf() + 60 * this._get_timepicker_step() * 1e3);
        ...
        _fill_lightbox_select: function(t, e, n, i, a) {
            if (t[e + i[0]].value = n.getDate(),
            t[e + i[1]].value = n.getMonth(),
            t[e + i[2]].value = n.getFullYear(),
            dhtmlx.defined(i[3])) {
        ...
        select: {
            render: function(t) {
                for (var e = (t.height || "23") + "px", n = "<div class='gantt_cal_ltext' style='height:" + e + ";'><select style='width:100%;'>", i = 0; i < t.options.length; i++)
                    n += "<option value='" + t.options[i].key + "'>" + t.options[i].label + "</option>";
                return n += "</select></div>"
            },
            set_value: function(t, e, n, i) {
                var a = t.firstChild;
        ...
        time: {
            render: function(t) {
                ...
                return n.push(e),
                t.single_date ? (e = this.form_blocks.getTimePicker.call(this, t, !0),
                n.push("<span></span>")) : n.push("<span style='font-weight:normal; font-size:10pt;'> &nbsp;&ndash;&nbsp; </span>"),
                n.push(e),
                n.push("</div>"),
                n.join("")
            },
            set_value: function(t, e, n, i) {
                ...
                if (a.auto_end_date)
                    for (var o = function() {
                        l = new Date(s[r[2]].value,s[r[1]].value,s[r[0]].value,0,0),
                        h = gantt.calculateEndDate(l, 1),
                        this.form_blocks._fill_lightbox_select(s, r.size, h, r, a)
                    }, d = 0; 4 > d; d++)
                        s[d].onchange = o;
                ...
                this.form_blocks._fill_lightbox_select(s, 0, l, r, a),
                this.form_blocks._fill_lightbox_select(s, r.size, h, r, a)
            },
            get_value: function(t, e, n) {
        ...
        duration: {
            ...
            set_value: function(t, e, n, i) {
                ...
                l[1].onclick = dhtmlx.bind(function() {
                    s(1 * this.config.duration_step)
                }, this),
                o[0].onchange = a,
                o[1].onchange = a,
                o[2].onchange = a,
                o[3] && (o[3].onchange = a),
                _.onkeydown = dhtmlx.bind(function(t) {
                    t = t || window.event;
                    var e = t.charCode || t.keyCode || t.which;
                    return 40 == e ? (s(-1 * this.config.duration_step),
                    !1) : 38 == e ? (s(1 * this.config.duration_step),
                    !1) : void window.setTimeout(function(t) {
                        a()
                    }, 1)
                }, this),
                _.onchange = dhtmlx.bind(function(t) {
                    a()
                }, this);
                ...
                gantt.form_blocks._fill_lightbox_select(o, 0, u, g, r),
                _.value = p,
                a()
            },
            _get_start_date: function(t, e) {
                ...
                if (dhtmlx.defined(i[3])) {
                    ...
                    isNaN(o) && r.hasAttribute("data-value") && (o = parseInt(r.getAttribute("data-value"), 10)),
                    a = Math.floor(o / 60),
                    s = o % 60
                }
            ...
            _get_duration: function(t, e) {
                ...
                return n = parseInt(n.value, 10),
                (!n || window.isNaN(n)) && (n = 1),
                0 > n && (n *= -1),
                n
            },
            get_value: function(t, e, n) {
        ...
        parent: {
            _filter: function(t, e, n) {
                ...
                for (var a = 0; a < t.length; a++) {
                    var s = t[a];
                    (s.id == n || gantt.isChildOf(s.id, n) || i(s.id, s) === !1) && (t.splice(a, 1),
                    a--)
                }
                return t
            },
            _display: function(t, e) {
                var n = []
                  , i = [];
                e && (n = gantt.getTaskByTime(),
                t.allow_root && n.unshift({
            ...
            set_value: function(t, e, n, i) {
                ...
                return t.onselect = null,
                t.parentNode.replaceChild(s, t),
                gantt.form_blocks.select.set_value.apply(gantt, [s, e, n, i]);
            },
            get_value: function() {
        ...
        var e = t
          , n = {
            ...
            set_value: function(t, i, a, s) {
                ...
                if (!a[r.start_date] || "start_date" == r.start_date && this._isAllowedUnscheduledTask(a)) {
                    n.disable(t, s);
                    var o = {};
                    for (var d in r)
                        o[r[d]] = a[d];
                ...
                return n.enable(t, s),
                e.set_value.call(gantt, t, i, a, s)
            },
            ...
            update_block: function(t, e) {
                if (gantt.callEvent("onSectionToggle", [gantt._lightbox_id, e]),
    ...
    gantt._init_dp_live_update_hooks = function(t) {
        t.attachEvent("insertCallback", gantt._insert_callback),
        t.attachEvent("updateCallback", gantt._update_callback),
        ...
        if (gantt.isTaskExists(e)) {
            ...
            for (var a in n) {
                ...
                case "end_date":
                    ...
                    break;
                case "duration":
                    i.end_date = gantt.calculateEndDate(i.start_date, s)
                }
                i[a] = s
            }
            gantt.updateTask(e),
    ...
    ,
    gantt._insert_callback = function(t, e, n, i) {
        var a = t.data || gantt.xml._xmlNodeToJSON(t.firstChild)
          , s = {
            add: gantt.addTask,
            isExist: gantt.isTaskExists
        };
        "links" == i && (s.add = gantt.addLink,
        s.isExist = gantt.isLinkExists),
        s.isExist.call(gantt, e) || (a.id = e,
        s.add.call(gantt, a))
    }
    ,
    gantt._delete_callback = function(t, e, n, i) {
        var a = {
            "delete": gantt.deleteTask,
            isExist: gantt.isTaskExists
        };
        "links" == i && (a["delete"] = gantt.deleteLink,
        a.isExist = gantt.isLinkExists),
        a.isExist.call(gantt, e) && a["delete"].call(gantt, e)
    }
    ,
    gantt._get_safe_type = function(t) {
        for (var e in this.config.types)
    ...
    function() {
        function t() {
            return gantt._cached_functions.update_if_changed(gantt),
            gantt._cached_functions.active || gantt._cached_functions.activate(),
            !0
        }
        gantt._cached_functions = {
            ...
            prefetch: function(t, e) {
                ...
                if (n) {
                    ...
                    e[t] = function() {
                        if (i.active) {
                            var e = i.get_arguments_hash(Array.prototype.slice.call(arguments));
                            i.cache[t] || (i.cache[t] = {});
                            var a = i.cache[t];
                            if (i.has_cached_value(a, e))
                                return i.get_cached_value(a, e);
                            var s = n.apply(this, arguments);
                            return i.cache_value(a, e, s),
                            s
                        }
            ...
            setup: function(t) {
                ...
                "auto" == this.mode ? t.config.highlight_critical_path && (e = n) : this.mode === !0 && (e = n),
            ...
            update_if_changed: function(t) {
                ...
                e && (this.critical_path_mode = t.config.highlight_critical_path,
                this.mode = t.config.optimize_render,
                this.setup(t))
            }
        },
        gantt.attachEvent("onBeforeGanttRender", t),
        gantt.attachEvent("onBeforeDataRender", t),
        gantt.attachEvent("onBeforeParse", t),
    ...
    gantt.init = function(t, e, n) {
        ...
        e && n && (this.config.start_date = this._min_date = new Date(e),
    ...
    gantt._init_html_area = function(t) {
        "string" == typeof t ? this._obj = document.getElementById(t) : this._obj = t,
        window.gantt !== gantt && (this._obj.gantt = gantt),
        dhtmlx.assert(this._obj, "Invalid html container: " + t);
        ...
        buttons: {
            ...
            "delete": function(t) {
                ...
                gantt._dhtmlx_confirm(e, n, function() {
                    ...
                    e.$new ? (gantt._deleteTask(t, !0),
                    gantt.refreshData()) : gantt.deleteTask(t),
                    gantt.hideLightbox()
                })
            }
        }
    ...
    gantt._get_box_styles = function() {
        ...
        for (var i = 0; i < e.length; i++)
            n[e[i]] = t[e[i]] ? this._clean_el_size(t[e[i]]) : 0;
        var a = {
        ...
        return a.borderBox ? (a.innerWidth -= a.horPaddings,
        a.innerHeight -= a.vertPaddings) : (a.outerWidth += a.horPaddings,
    ...
    gantt._do_autosize = function() {
        ...
        if (t.y) {
            ...
            e.borderBox && (n += e.vertPaddings),
            this._obj.style.height = n + "px"
        }
        if (t.x) {
            var i = this._calculate_content_width();
            e.borderBox && (i += e.horPaddings),
            this._obj.style.width = i + "px"
        }
    }
    ,
    gantt._set_sizes = function() {
        ...
        !(this._y < 20)) {
            ...
            this.$grid.style.width = n + "px",
            this.$grid.style.display = 0 === n ? "none" : "",
            t = this._get_box_styles(),
            this._x = t.innerWidth,
            this._x < 20 || (this.$grid_data.style.width = Math.max(this._get_grid_width() - 1, 0) + "px",
    ...
    gantt._save_scroll_state = function(t, e) {
        ...
        void 0 !== t && (n.x = Math.max(t, 0)),
        void 0 !== e && (n.y = Math.max(e, 0)),
        dhtmlx.mixin(this._cached_scroll_pos, n, !0)
    }
    ,
    ...
    gantt.scrollTo = function(t, e) {
        ...
        this._save_scroll_state(t, void 0)),
        1 * e == e && (this.$task_data.scrollTop = e,
        this.$grid_data.scrollTop = e,
        this._save_scroll_state(void 0, e));
        var n = gantt._restore_scroll_state() || {
            x: 0,
            y: 0
        };
        this.callEvent("onGanttScroll", [n.x, n.y])
    }
    ,
    ...
    gantt._set_scroll_events = function() {
        function t(t) {
            ...
            if (i && Math.abs(i) > Math.abs(a)) {
                ...
                gantt.scrollTo(r, null),
                gantt.$scroll_hor.scrollTop = o
            } else {
                if (n.y)
                    return !0;
                var s = a / -40;
                ...
                if (!gantt.config.prevent_default_scroll && gantt._cached_scroll_pos && gantt._cached_scroll_pos.y == o)
                    return !0;
                gantt.scrollTo(null, o),
                gantt.$scroll_ver.scrollTop = o
            }
        ...
        dhtmlxEvent(this.$scroll_ver, "scroll", function() {
            if (!gantt._touch_scroll_active) {
                ...
                gantt.$grid_data.scrollTop = t,
                gantt.scrollTo(null, t)
            }
        }),
    ...
    gantt._scroll_resize = function() {
        if (!(this._x < 20 || this._y < 20)) {
            ...
            this.$scroll_hor.style.display = o ? "block" : "none",
            this.$scroll_hor.style.height = (o ? i : 0) + "px",
            this.$scroll_hor.style.width = Math.max(this._x - (d ? i : 2), 0) + "px",
            this.$scroll_hor.firstChild.style.width = a + t + i + 2 + "px",
            this.$scroll_ver.style.display = d ? "block" : "none",
            this.$scroll_ver.style.width = (d ? i : 0) + "px",
            this.$scroll_ver.style.height = Math.max(this._y - (o ? i : 0) - this.config.scale_height, 0) + "px",
            this.$scroll_ver.style.top = this.config.scale_height + "px",
            this.$scroll_ver.firstChild.style.height = this.config.scale_height + s + "px";
        }
    }
    ,
    ...
    gantt.locate = function(t) {
        var e = gantt._get_target_node(t)
          , n = gantt._getClassName(e);
        if ((n || "").indexOf("gantt_task_cell") >= 0)
            return null;
    ...
    gantt._get_target_node = function(t) {
        var e;
        return t.tagName ? e = t : (t = t || window.event,
    ...
    gantt.selectTask = function(t) {
        if (!this.config.select_task)
            return !1;
        if (t) {
            if (this._selected_task == t)
                return this._selected_task;
            if (!this.callEvent("onBeforeTaskSelected", [t]))
                return !1;
            this.unselectTask(),
    ...
    gantt.batchUpdate = function(t) {
        ...
        this._skip_render = !1,
        this.render(),
        n && (this._dp.setUpdateMode(e),
        this._dp.sendData())
    }
    ,
    gantt.date = {
        init: function() {
            for (var t = gantt.locale.date.month_short, e = gantt.locale.date.month_short_hash = {}, n = 0; n < t.length; n++)
                e[t[n]] = n;
            for (var t = gantt.locale.date.month_full, e = gantt.locale.date.month_full_hash = {}, n = 0; n < t.length; n++)
                e[t[n]] = n
        },
        ...
        week_start: function(t) {
            var e = t.getDay();
            return gantt.config.start_on_monday && (0 === e ? e = 6 : e--),
        ...
        _add_days: function(t, e) {
            ...
            e >= 0 && !t.getHours() && n.getHours() && (n.getDate() <= t.getDate() || n.getMonth() < t.getMonth() || n.getFullYear() < t.getFullYear()) && n.setTime(n.getTime() + 36e5 * (24 - n.getHours())),
            n
        },
        add: function(t, e, n) {
        ...
        str_to_date: function(t, e) {
            for (var n = "var temp=date.match(/[a-zA-Z]+|[0-9]+/g);", i = t.match(/%[a-zA-Z]/g), a = 0; a < i.length; a++)
                switch (i[a]) {
                case "%j":
                case "%d":
                    n += "set[2]=temp[" + a + "]||1;";
        ...
        parseDate: function(t, e) {
            return "string" == typeof t && (dhtmlx.defined(e) && (e = "string" == typeof e ? dhtmlx.defined(gantt.templates[e]) ? gantt.templates[e] : gantt.date.str_to_date(e) : gantt.templates.xml_date),
            t = t ? e(t) : null),
            t
        }
    },
    ...
    gantt.config || (gantt.config = {}),
    gantt.templates || (gantt.templates = {}),
    function() {
        ...
        gantt._init_template = function(t, e, n) {
            var i = this._reg_templates || {};
            n = n || t,
            this.config[t] && i[n] != this.config[t] && (e && this.templates[n] || (this.templates[n] = this.date.date_to_str(this.config[t]),
            i[n] = this.config[t])),
            this._reg_templates = i
        }
        ,
        gantt._init_templates = function() {
            var t = gantt.locale.labels;
            t.gantt_save_btn = t.icon_save,
            t.gantt_cancel_btn = t.icon_cancel,
            t.gantt_delete_btn = t.icon_delete;
            var e = this.date.date_to_str
              , n = this.config;
            gantt._init_template("date_scale", !0),
            gantt._init_template("date_grid", !0, "grid_date_format"),
            gantt._init_template("task_date", !0),
            dhtmlx.mixin(this.templates, {
                ...
                drag_link: function(t, e, n, i) {
                    ...
                    return n && (n = gantt.getTask(n),
                    s += "<b> " + n.text + "</b> " + (i ? a.link_start : a.link_end) + "<br/>"),
                    s
                },
    ...
    window.dhtmlx && (dhtmlx.attaches || (dhtmlx.attaches = {}),
    dhtmlx.attaches.attachGantt = function(t, e) {
        var n = document.createElement("DIV");
        n.id = "gantt_" + dhtmlx.uid(),
        n.style.width = "100%",
        n.style.height = "100%",
        n.cmp = "grid",
    ...
    gantt.config.touch = !0,
    gantt.config.touch_feedback = !0,
    ...
    gantt._touch_events = function(t, e, n) {
            ...
            if (!n(t) && o) {
                ...
                if (a && _) {
                    var h = _.pageX - a.pageX
                      , g = _.pageY - a.pageY;
                    if (!d && (Math.abs(h) > 5 || Math.abs(g) > 5) && (gantt._touch_scroll_active = d = !0,
                    r = 0,
                    s = gantt.getScrollState()),
                    d) {
                        gantt.scrollTo(s.x + h, s.y + g);
                        var c = gantt.getScrollState();
                        if (s.x != c.x && g > 2 * h || s.y != c.y && h > 2 * g)
                            return i(t);
                    }
                }
                return i(t)
        ...
        dhtmlxEvent(this.$container, t[1], function(t) {
            if (!n(t)) {
                ...
                _ && r) {
                    var s = new Date;
                    500 > s - r ? (gantt._on_dblclick(_),
                    i(t)) : r = s
                } else
                    r = new Date;
                l = setTimeout(function() {
                    var t = gantt.locate(_);
                    !t || gantt._locate_css(_, "gantt_link_control") || gantt._locate_css(_, "gantt_grid_data") || (gantt._tasks_dnd.on_mouse_down(_),
                    gantt._tasks_dnd.drag && gantt._tasks_dnd.drag.start_drag && (a(t),
                    gantt._tasks_dnd._start_dnd(_),
                    gantt._touch_drag = !0,
                    gantt.refreshTask(t),
        ...
        dhtmlxEvent(this.$container, t[2], function(t) {
            if (!n(t)) {
                ...
                h && (gantt.refreshTask(gantt.locate(h)),
                h.parentNode && (h.parentNode.removeChild(h),
                gantt._touch_feedback())),
                gantt._touch_scroll_active = o = d = !1,
                h = null
            }
        })
    }
    ...
    return gantt._internal_id = Gantt._seed++,
    Gantt.$syncFactory && Gantt.$syncFactory(gantt),
    gantt
}
,
window.gantt = Gantt.getGanttInstance(),
dhtmlx && (dhtmlx.attaches = dhtmlx.attaches || [],
dhtmlx.attaches.attachGantt = function(t, e, n) {
    var i = document.createElement("DIV");
    return i.id = "dhxSchedObj_" + this._genStr(12),
    i.style.cssText = "width:100%; height:100%;",
    document.body.appendChild(i),
    this.attachObject(i.id, !1, !0),
    n = n || (window.gantt.$container ? Gantt.getGanttInstance() : window.gantt),
    this.vs[this.av].sched = n,
    this.vs[this.av].schedId = i.id,
