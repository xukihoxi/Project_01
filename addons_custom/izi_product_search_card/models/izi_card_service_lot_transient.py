...
class StockProductionLot(models.TransientModel):
    _name = 'izi.card.service.lot.transient'
    ...
    x_status = fields.Selection(
        [('new', 'New'), ('actived', 'Actived'), ('using', 'Using'), ('used', 'Used'), ('destroy', 'Destroy')], string='Status')
